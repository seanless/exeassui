...
function getJsonMessage(jsonMsg) {
  ...
  console.log("message: " + JSON.parse(jsonMsg.data)["text"], offline_text);
  offline_text =
    offline_text !== "undefined" && offline_text ? offline_text : "";
  rec_text = rec_text !== "undefined" && rec_text ? rec_text : "";
  ...
  //   console.log("window.setInputValue: " + window.setInputValue);
  window.setInputValue && window.setInputValue(rec_text);
  if( !window.isRec ){
    window.wsconnecter.wsStop()
  }
  //   if (is_final == true) {
  //     rec_text = "";
  //     offline_text = "";
...
function getConnState(connState) {
  if (connState === 0) {
    ...
    console.log("connecttion ok", connState);
