...
const ExeassIndex = () => {
  ...
  const columns = [
    ...
    { title: "总时长(h)", dataIndex: "all_hours" },
    { title: "服务时长(h)", dataIndex: "all_service_hours" },
    { title: "报告时长(h)", dataIndex: "all_report_hours" },
    { title: "交通时长(h)", dataIndex: "all_transport_hours", },
    { title: "等待时长(h)", dataIndex: "all_wait_hours", },
    { title: "Other时长(h)", dataIndex: "all_other_hours", },
    { title: "差旅费用(RMB)", dataIndex: "all_transport_fee" },
